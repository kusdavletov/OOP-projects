...
v2.print();
  ...
  cout << findNode(v1.getHeadItr(), v1.getTailItr(), "Name") << endl;
  cout << findNode(v1.getHeadItr(), v1.getTailItr(), "Porter") << endl;
  cout << findNode(v1.getHeadItr(), v1.getTailItr(), "James") << endl;
  cout << findNode(v1.getHeadItr(), v1.getTailItr(), "Is") << endl;
  cout << findNode(v1.getHeadItr(), v1.getTailItr(), "My") << endl;
  cout << findNode(v1.getHeadItr(), v1.getTailItr(), "ERNAR") << endl;
  // empty buffe
  v1.consumeAtHead();
  v1.consumeAtHead();
  v1.print();
